...
async function main() {
    ...
    // 1. Load policy
    const policy = (0, src_1.loadPolicy)('./demo/policy.yaml');
    ...
    const capability = (0, src_1.issueCapability)({
        action: 'post',
        resource: '/twitter',
        key: SECRET_KEY,
        expiresIn: '10m',
    ...
    // 3. Policy check
    console.log('\n🔍 Checking policy...');
    const policyResult = (0, src_1.checkPolicy)({
        action: 'post',
        resource: '/twitter',
    ...
    const verification = (0, src_1.verifyCapability)({
        capability,
        key: SECRET_KEY
    });
    ...
    if (verification.valid && policyResult.allowed) {
        ...
        const tamperedVerification = (0, src_1.verifyCapability)({ capability: tamperedCap, key: SECRET_KEY });
        ...
        const expiredVerification = (0, src_1.verifyCapability)({ capability: expiredCap, key: SECRET_KEY });
